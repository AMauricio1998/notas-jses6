...
function agregarPlatillo(producto) { 
    ...
    if (producto.cantidad > 0) {
        ...
        if( pedido.some( articulo => articulo.id === producto.id)) {
            ...
            //El articulo no existe lo agrega al arreglo del pedido
...
function actualizarResumen() {
    ...
    //Agregar a los elementos padre
     ...
     pedido.forEach(articulo => {
        ...
        list.appendChild(nombreEl);
        list.appendChild(cantidadEl);
        list.appendChild(precioEl);
        list.appendChild(subtotalEl);
        list.appendChild(btnEliminar);
...
function calcularSubtotal(precio, cantidad) { 
 ...
 function eliminarProducto(id) {
    ...
    //Limpiar html del codigo previo
    limpiarHTML();
...
function calcularPropina() {
    ...
    // Clacular subtotal a pagar
    pedido.forEach( articulo => {
        subtotal += articulo.cantidad * articulo.precio;
    });

    //Seleccionar radio button de la propina del cliente
